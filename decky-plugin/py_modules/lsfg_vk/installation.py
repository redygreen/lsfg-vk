...
class InstallationService(BaseService):
    ...
    def install(self) -> InstallationResponse:
        ...
        try:
            ...
            # If on ARM, the bundled Adaptive layer is currently x86_64 only.
            if self._is_arm_architecture():
                self.log.warning(
                    "ARM host detected: this Adaptive plugin ships an x86_64 layer. "
                    "It will not overwrite official 1.x ARM binaries."
                )
