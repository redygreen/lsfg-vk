...
class Plugin:
    ...
    async def get_adaptive_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "ingest_fps": float(data.get("ingest_fps", 0.0)),
                "fg_fps": float(data.get("fg_fps", 0.0)),
    ...
    async def _main(self):
        ...
        """
        decky.logger.info("decky-lsfg-vk-adaptive plugin loaded")
    ...
    async def _unload(self):
        ...
        """
        decky.logger.info("decky-lsfg-vk-adaptive plugin unloaded")
    ...
    async def _uninstall(self):
        ...
        """
        decky.logger.info("decky-lsfg-vk-adaptive plugin being uninstalled")
        ...
        decky.logger.info("decky-lsfg-vk-adaptive plugin uninstall cleanup completed")
    ...
    async def _migration(self):
        ...
        """
        decky.logger.info("Running decky-lsfg-vk-adaptive plugin migrations")
        ...
        decky.logger.info("decky-lsfg-vk-adaptive plugin migrations completed")
